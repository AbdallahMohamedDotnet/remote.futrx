...
| Claude/Codex versions | [`agent-cli-versions.env`](backend/internal/agent/provisioning/agent-cli-versions.env) — shared by the host installer, base image, and container self-healing |
