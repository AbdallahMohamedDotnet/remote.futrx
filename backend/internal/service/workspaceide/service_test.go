...
func TestOpenURLMapsProjectPathsIntoContainer(t *testing.T) {
	service := New("https://code.remote.futrx.dev/", "/var/lib/remote/projects")
	...
	want := "https://code.remote.futrx.dev/graphixy-ai/?file=%2Fworkspace%2Fsrc%2FApp.tsx&folder=%2Fworkspace"
	if got != want {
