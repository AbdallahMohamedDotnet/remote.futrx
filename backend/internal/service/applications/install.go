...
func (s *Service) Install(ctx context.Context, req InstallRequest) (View, error) {
	...
	// A backend application has no container side at all: installing one only records
	...
	// script — exists only for applications that provision software.
