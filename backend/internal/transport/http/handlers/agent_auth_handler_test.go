...
func newTestAgentAuthHandler() *AgentAuthHandler {
	...
	codexBinding := agentauth.NewDeviceBinding(agent.ProviderCodex, device("codex CLI not found on PATH - install it first")).WithAccounts(&agentAuthMemoryAccounts{
