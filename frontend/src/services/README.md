...
set of subscriptions, keyed by the application that registered them. That is not the
...
`app/extensions/` subscribes an application and drops it on uninstall, while
