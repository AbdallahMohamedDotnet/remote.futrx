...
import type { SecurityAlertSummary, SessionHistoryEntry } from "../../models/security";
import { AlertCircle, Check, Clock, Key, Loader, ShieldCheck } from "../primitives/icons";
...
function SessionHistoryList({ sessions }: { sessions: SessionHistoryEntry[] }) {
  if (!sessions?.length) {
    return (
...
function TwoFactorSection({ controller }: { controller: SecuritySettingsController }) {
