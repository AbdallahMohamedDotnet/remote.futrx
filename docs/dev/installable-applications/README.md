# Installable applications and UI extensions
...
`docs/dev/installable-applications/`, while the thing they describe is a directory of
...
Keeping the two apart is deliberate: everything under `applications/` is embedded
